...
RUN set -ex; cd /go/src/github.com/IBM/ibmcloud-object-storage-plugin/ && CGO_ENABLED=0 go install -v github.com/IBM/ibmcloud-object-storage-plugin/cmd/watcher
